...
# add include path
INCLUDEPATH += "C:/Program Files (x86)/IDA 6.8/SDK68/include"
...
LIBDIR = "C:/Program Files (x86)/IDA 6.8/SDK68/lib/x86_win_vc_32/"
LIBS += -L$${LIBDIR} -lida
...
DESTDIR = $$PWD/bin/$${TARGET_PROCESSOR_NAME}_$${SYSNAME}_$${COMPILER_NAME}$${OPTSUF}/plugins/
